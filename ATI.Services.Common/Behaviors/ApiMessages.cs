namespace ATI.Services.Common.Behaviors
{
    public static class ApiMessages
    {
        ...
        public const string UnknowErrorMessage = "Произошла неизвестная ошибка";
        public const string NotFoundErrorMessage = "Ресурс не найден";
        public const string Unauthorized = "Не авторизован";
        public const string FullRegistrationRequired = "Недоступно до завершения полной регистрации.";
    }
}
